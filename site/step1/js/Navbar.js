...
class Navbar extends React.Component {
	...
	async handle_ask_join() {
		...
		if (response.status != 200) throw new Error('Error while asking to join' + response.text());else {
	...
	async handle_logout() {
		...
		if (response.status != 200) throw new Error('Error while fetching posts' + response.text());
		this.delete_cookie();
				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								"span",
								{ "class": "navItem", onClick: () => this.props.change_view("Home") },
								"Home"
							),
							React.createElement(
								"span",
								{ "class": "navItem", onClick: () => this.props.change_view("Messages") },
								"Messages"
							),
							React.createElement(
								"span",
								{ "class": "navItem", onClick: () => this.props.change_view("About") },
								"About"
							),
							React.createElement(
								"span",
								{ "class": "navItem", onClick: this.handle_ask_join },
								"Ask to join"
							),
							React.createElement(
								"span",
								{ "class": "navItem", onClick: this.handle_logout },
								"Logout"
							)
						)
					)
			...
			case "True":
				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							"span",
							{ "class": "navItem", onClick: () => this.props.change_view("Admin") },
							"Admin"
						),
						React.createElement(
							"span",
