            ...
            <fieldset>
              ...
              <ul>
                <li>
                  ...
                  <input value={this.get_cookie("email")? this.state.email=this.get_cookie("email"): this.state.email} onChange={this.handleChange} 
				       type="text" id="email" placeholder={this.get_cookie("email")} required/>
                </li>
                <li>
                  <label for="password">Password:</label>
                  <input value={this.get_cookie("password")? this.state.password=this.get_cookie("password"): this.state.password} onChange={this.handleChange} 
				  type="password" id="password" required/>
                </li>
              </ul>
            </fieldset>
            <button type="button" onClick={this.handleLogin}>Login</button>
            <button type="button" onClick={ () => this.props.change_view("signUp")}>Create an Account</button>
          </form>
		)
	}
}
